...
export default function FloatingContact() {
  ...
  return (
    <>
      {/* Desktop: vertical stack, clear of the container gutter */}
      <div
        className={cn(
          "fixed left-2 top-1/2 z-40 hidden -translate-y-1/2 flex-col gap-3 transition-opacity duration-300 lg:flex",
      ...
      >
        <a
          ...
          className="btn-focus flex h-10 w-10 items-center justify-center rounded-full bg-[#e5493f] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110"
        >
          <Phone size={16} strokeWidth={2} fill="currentColor" />
        </a>
        <a
          href={MESSENGER_LINK}
          target="_blank"
          ...
          className="btn-focus flex h-10 w-10 items-center justify-center rounded-full bg-[#0084ff] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110"
        >
          <MessengerIcon />
        </a>
        <a
          ...
          className="btn-focus flex h-10 w-10 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110"
        >
          <WhatsAppIcon />
        </a>
      </div>
      ...
      <div
        className={cn(
          "fixed bottom-4 right-4 z-40 flex flex-col gap-2.5 transition-opacity duration-300 lg:hidden",
          hidden && "pointer-events-none opacity-0"
        )}
      >
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Message on WhatsApp"
          className="btn-focus flex h-11 w-11 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg shadow-black/25 transition-transform duration-300 hover:scale-110"
        >
          <WhatsAppIcon />
        </a>
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Message on Messenger"
          className="btn-focus flex h-11 w-11 items-center justify-center rounded-full bg-[#0084ff] text-white shadow-lg shadow-black/25 transition-transform duration-300 hover:scale-110"
        >
          <MessengerIcon />
        </a>
        <a
          href={PHONE_LINK}
          aria-label="Call Goldenhair"
          className="btn-focus flex h-11 w-11 items-center justify-center rounded-full bg-[#e5493f] text-white shadow-lg shadow-black/25 transition-transform duration-300 hover:scale-110"
        >
